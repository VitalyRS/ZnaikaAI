...
def generate_prompt(text, url, style_key, length_key):
    ...
    "style1": (
        ...
        f"Только заголовок выдели как **ОГЛАВЛЕНИЕ**, в остальном — без оформления и восклицательных знаков. "
        f"Длина около {length} символов. В конце добавь ссылку: {url}, затем 5 испанских и 5 русских хэштегов. "
        f"Исходный текст:\n{text}"
    ),

    "style2": (
        f"Сделай ироничный пересказ текста на русском. Заголовок выдели как **ОГЛАВЛЕНИЕ**, без восклицаний и другого оформления. "
        f"Длина около {length} символов. В конце добавь ссылку: {url}, затем 5 испанских и 5 русских хэштегов. "
        f"Текст:\n{text}"
    ),
    ...
    "style3": (
        ...
        f"Заголовок выдели как **ОГЛАВЛЕНИЕ**, больше ничего не выделяй. Объём — примерно {length} символов. "
    ...
    "style4": (
        ...
        f"Выдели только заголовок как **ОГЛАВЛЕНИЕ**, не используй символы оформления или восклицания. "
    ...
    "style5": (
        ...
        f"Стиль спокойный. Только заголовок выдели как **ОГЛАВЛЕНИЕ**, остальное — без оформления и восклицаний. "
    ...
    "style7": (
        ...
        f"Выдели только заголовок как **ОГЛАВЛЕНИЕ**, не используй символы оформления и восклицания. "
        f"Длина около {length} символов. В конце добавь ссылку: {url}, 5 испанских и 5 русских хэштегов. "
        f"Текст:\n{text}"
    ),
}
