...
def generate_prompt(text, url, style_key, length_key):
    ...
    "style7": (
        ...
        шизоидного бреда в духе магического мышления  и Главное включить слова : высоковибрационный, духовный рост, переход в новую реальность,
        осознанность и ещё что-нибудь про пробуждение плюс раскрытие сахасрары . "
        f"Заголовок выдели **жирным**, но в тексте НИКАКИХ звёздочек — даже если кажется, что они нужны для 'акцента'. "
